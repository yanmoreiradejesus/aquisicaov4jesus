...
CREATE OR REPLACE FUNCTION public.get_sdr_activity_stats(p_start timestamptz, p_end timestamptz, p_pipe text DEFAULT 'all')
 RETURNS TABLE(user_id uuid, ligacoes bigint, contato_realizado bigint, reunioes_agendadas bigint, reunioes_realizadas bigint, no_show bigint)
 LANGUAGE plpgsql
...
CREATE OR REPLACE FUNCTION public.get_sdr_activity_totals(p_start timestamptz, p_end timestamptz, p_pipe text DEFAULT 'all')
 RETURNS TABLE(ligacoes bigint, contato_realizado bigint, reunioes_agendadas bigint, reunioes_realizadas bigint, no_show bigint)
 LANGUAGE plpgsql
 STABLE SECURITY DEFINER
 SET search_path TO 'public'
AS $function$
