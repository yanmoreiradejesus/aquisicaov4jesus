...
RETURNS TABLE(user_id uuid, ligacoes bigint, contato_realizado bigint, reunioes_agendadas bigint, reunioes_realizadas bigint, no_show bigint, conversoes bigint)
...
RETURNS TABLE(ligacoes bigint, contato_realizado bigint, reunioes_agendadas bigint, reunioes_realizadas bigint, no_show bigint, conversoes bigint)
LANGUAGE plpgsql STABLE SECURITY DEFINER SET search_path = public
AS $$
DECLARE
  v_tenant uuid;
