...
const ConversionFunnel = ({ data, leads, allLeads, filters, useCreationDate = false }: ConversionFunnelProps) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-center lg:hidden opacity-0 animate-fade-in" style={{ animationDelay: '100ms' }}>
      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-[1fr_4fr_1fr] gap-6">
        ...
        <div className="hidden lg:flex items-center justify-center opacity-0 animate-fade-in" style={{ animationDelay: '100ms' }}>
        ...
        <div className="hidden lg:block space-y-8">
          {intermediateRates.map((rate, index) => (
            <div key={index} className="text-center pt-6 opacity-0 animate-fade-in" style={{ animationDelay: `${(index + 5) * 150}ms` }}>
      ...
      <div className="lg:hidden grid grid-cols-2 gap-3">
        {intermediateRates.map((rate, index) => (
          <div key={index} className="text-center p-3 rounded-lg bg-gradient-to-br from-card to-muted/5 border border-border/50 opacity-0 animate-fade-in" style={{ animationDelay: `${(index + 5) * 150}ms` }}>
            <p className="mb-1 font-body text-xs text-muted-foreground">{rate.label}</p>
