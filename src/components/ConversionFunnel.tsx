...
const ConversionFunnel = ({ data }: ConversionFunnelProps) => {
  ...
  const intermediateRates = [
    { label: "MQL → C.R", rate: stages[1].conversionRate },
    { label: "C.R → R.A", rate: stages[2].conversionRate },
    { label: "R.A → R.R", rate: stages[3].conversionRate },
    { label: "R.R → ASS", rate: stages[4].conversionRate },
  ];
